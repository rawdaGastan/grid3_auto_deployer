...
require (
	...
	github.com/threefoldtech/tfgrid-sdk-go/grid-client v0.15.5
	github.com/threefoldtech/tfgrid-sdk-go/grid-proxy v0.15.5
...
require (
	...
	github.com/threefoldtech/tfgrid-sdk-go/rmb-sdk-go v0.15.5 // indirect
