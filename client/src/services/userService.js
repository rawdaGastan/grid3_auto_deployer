...
export default {
    ...
    async charge(balance, success_url, failure_url) {
        await this.refresh_token();
        return await authClient().post("/balance/charge", {
            balance,
            success_url,
            failure_url,
        });
    ...
    async charged(balance) {
        await this.refresh_token();
        return await authClient().post("/balance/charged", {
            balance,
        });
    },
    ...
    async getBalanceTFT() {
        await this.refresh_token();
        return await authClient().get("/balance/tft");
    },
